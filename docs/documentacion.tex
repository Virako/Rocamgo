...
%\include{src-module}
%\include{src.camera-module} v
%\include{src.cameras-module} v
%\include{src.check_goban_moved-module}v
%\include{src.cte-module}
%\include{src.functions-module}
%\include{src.goban-module}v
%\include{src.igs-module}v
%\include{src.kifu-module}v
%\include{src.perspective-module}v
%\include{src.rocamgo-module}
%\include{src.search_goban-module} v
%\include{src.search_stones-module} v
%\include{src.stone-module} v
...
\include{src.camera-module}
\include{src.cameras-module}
...
\include{src.search_goban-module}
...
\include{src.check_goban_moved-module}
...
\include{src.perspective-module}
...
\include{src.search_stones-module} 
\include{src.stone-module}
