...
\begin{itemize}
    \item Cámara: 30 \euro{}
    \item Alcohol para resistir programando toda la noche: 50 \euro{}
\end{itemize}
...
%http://alejandroandres.com/blog/2011/06/mi-workflow-con-git/
...
%http://www.magmax.org/2011/11/09/python-pruebas-4.html
%
...
%http://www.linuxoriente.edu.sv/index.php?readmore=84
%Brazo robótico por 55
%http://www.extremetech.com/extreme/98623-how-to-make-a-voice-controlled-robotic-arm-for-55?f=2
%
%Tutorial para contruir el robot de 55
...
%http://www.youtube.com/watch?v=lJehPbpA7AM
%Video de otro posible brazo
%http://www.youtube.com/watch?v=d2OBCpbCEc4&feature=player_embedded
...
%
%Kifu
%http://wiki.elphel.com/index.php?title=Kifu:_Go_game_record_(kifu)_generator
%
...
%https://docs.google.com/View?docID=drw35kw_6gr8r84fs
%Programa prueba con codigo
%http://www.codeproject.com/KB/audio-video/haar_detection.aspx
%Explicacion
%http://www.coplec.org/?q=2010/08/05/entrenar-opencv
%
%\subsection{Enlaces interesantes sobre detección de objetos}
%
%[1]":http://achuwilson.wordpress.com/2011/02/13/object-detection-using-opencv-using-haartraining/
...
%* "[4]":http://en.wikipedia.org/wiki/Object_recognition_(computer_vision)
%* "[5]":http://en.wikipedia.org/wiki/Template_matching
%* "[6]":http://en.wikipedia.org/wiki/Pattern_recognition
%* "[7]":http://www.pigeon.psy.tufts.edu/avc/kirkpatrick/
%
%\subsection{ Enlaces de proyectos interesantes}
%
%* "Proyecto de go usando un proyector":http://www.youtube.com/watch?feature=player_embedded&v=33Iyr16yhJQ
%
%h1. Enlace a cosas relacionadas con imagenes.
%
%* "[1]":http://www.google.com/url?sa=t&rct=j&q=recortar%20imagenes%20roi%20opencv&source=web&cd=1&ved=0CB8QFjAA&url=http%3A%2F%2Fdis.um.es%2F~ginesgm%2Ffiles%2Fdoc%2Fpav%2Ftema2.ppt&ei=itA4T_2MBMLBhAfBl8CKAg&usg=AFQjCNGtmUXCybgKwHb5g8-Ns1F7Mdxz1A
%* "ROI":http://nashruddin.com/OpenCV_Region_of_Interest_(ROI)
